webpackJsonp([3], {
    ...
    var n = (function() {
      ...
      t = function(e, t) {
        ...
        if (
          ...
          if (((e.__resizeListeners__ = []), f))
            (e.__resizeTrigger__ = e), e.attachEvent('onresize', o)
          else {
            'static' === getComputedStyle(e).position &&
              (e.style.position = 'relative')
            var c = (e.__resizeTrigger__ = i.createElement('object'))
            c.setAttribute(
              'style',
  ...
  './node_modules/process/browser.js': function(e, t) {
    ...
    function i() {
      u &&
        b &&
        ((u = !1), b.length ? (p = b.concat(p)) : (w = -1), p.length && f())
    }
    function f() {
      if (!u) {
        var e = r(i)
    ...
    ;(m.nextTick = function(e) {
      ...
      p.push(new c(e, t)), 1 !== p.length || u || r(f)
    }),
  ...
  './node_modules/raf/index.js': function(e, t, o) {
    for (
      ...
      (f = r[a[l] + 'Request' + i]),
        (c = r[a[l] + 'Cancel' + i] || r[a[l] + 'CancelRequest' + i])
    if (!f || !c) {
      s = !1
      var d = 0,
        m = 0,
  ...
  './node_modules/react-responsive-grid/dist/components/Breakpoint.js': function(
    ...
    ;(i = o('./node_modules/react/react.js')),
      (f = o('./node_modules/react-component-width-mixin/index.js')),
      (a = o('./node_modules/react-page-width/dist/index.js')),
      (c = o('./node_modules/object-assign/index.js')),
      (n = i.createClass({
      ...
      (e.exports = function(e) {
        ...
        return (
          ...
          l.last && 0 === l.post && 0 === l.squish
            ? (c = 0)
            : 0 !== l.post || 0 !== l.squish
              ? ((c = t(l.post) + t(l.squish)), l.last || (c += i))
              : (c = i),
          (a = l.last ? 'right' : 'left'),
          (d += '%'),
          (f += '%'),
            ...
            value: function() {
              ...
              return (
                ...
                l.default.createElement(
                  ...
                  l.default.createElement(
                    p.default,
                    f({ title: m.siteMetadata.title }, this.props)
                  ),
                  o()
                )
              )
...
//# sourceMappingURL=layout-component---index-ab1db6776c8721bd4661.js.map
